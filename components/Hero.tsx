...
function Hero() {
  ...
  return (
    <section
      id="hero"
      className=" hero lg:ml-16 mt-32 flex flex-col xl:flex-row "
    >
      <motion.div
        ref={ref}
        variants={boxVariant}
        initial="hidden"
        animate={control}
        className="text-center lg:text-start lg:ml-32"
      >
      ...
      <article className="flex items-center lg:hidden 2xl:flex 2xl:absolute top-48 right-52 max-w-[217px] max-h-[52px] backdrop-opacity-10 backdrop-invert bg-white/20 rounded-xl ">
      ...
      <article className="flex items-center justify-around lg:hidden 2xl:flex 2xl:absolute bottom-44 right-[430px] max-w-[290px] max-h-[58px] backdrop-opacity-10 backdrop-invert bg-white/20 rounded-xl  ">
      ...
      <article className="flex lg:hidden 2xl:flex 2xl:absolute bottom-4 opacity-80 right-52 backdrop-opacity-10 backdrop-invert bg-white/20 rounded-xl ">
